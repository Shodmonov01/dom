...
import heard from "../../assets/img/heart.svg";
import heard_n from "../../assets/img/icon_favorite.svg";
...
export const Header = () => {
  ...
  useEffect(() => {
    // Check if the current location is "/catalog" and set isSticky accordingly
      ...
      <div className={`burger__nav ${active ? "active" : ""}`}>
        <div className="geo">
          <img
            ...
            alt
          />
          <button type="button" className="city-list-btn">
            <span className="city-name_mod-white">Москва</span>
        ...
        <div className="burger__item">
          <button className="burger-btn catering__btn-burger">
            Повар - Кейтеринг
          </button>
          <button className="btn-orange call_request-btn">
            Заявка на подбор
          </button>
        </div>
        <div className="burger__item">
          <a className="burger__faq" href="#faq">
            Частые вопросы
          </a>
          <a className="burger__cooperation" href="#cooperation">
            Сотрудничество
          </a>
        </div>
        <div className="burger__item">
          <a className="burger__tel " href="tel:+79150188611" id="tel">
            ...
            <span className>+79150188611</span>
          </a>
          <div className="burger__links links">
            ...
            <a
              href="https://wa.me/79150188611?text=Добрый%20день,%20я%20хочу%20получить%20консультацию"
              className="whatsup"
            >
              <svg
                width={24}
