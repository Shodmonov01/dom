			...
			<div className='containers'>
				...
				<div class=''>
					<div className='accordion'>
						...
						<div className='accordion-item'>
							<div id='accordion-button' >
								<p className='accordion-title'>Можно ли разбить предоплату на несколько частей?</p>
								<p>+</p>
							</div>
						...
						<div className='accordion-item'>
							<div id='accordion-button' >
								<p className='accordion-title'>Можно ли приехать на просмотр?</p>
								<p>+</p>
							</div>
						...
						<div className='accordion-item'>
							<div id='accordion-button' >
								<p className='accordion-title'>Какое время заезда и выезда в дом и есть ли возможность сдвинуть заезд или выезд?</p>
								<p>+</p>
							</div>
